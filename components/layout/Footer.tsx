...
const footerLinks = {
  services: [
    { label: 'AV Integration', href: '#services' },
      ...
      <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-dark-400 max-w-md mb-6">
                Professional audiovisual integration services for commercial, residential,
                and corporate spaces. Bringing your vision to life with cutting-edge
                technology.
              </p>
              <div className="flex space-x-4">
                ...
                <a
                  href="#"
                  className="w-10 h-10 rounded-lg bg-dark-800 flex items-center justify-center text-dark-400 hover:text-white hover:bg-primary-500 transition-all duration-300"
                  aria-label="Facebook"
                >
        ...
        <div className="py-6 border-t border-dark-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-dark-500 text-sm">
            &copy; {currentYear} Onyx Integrations. All rights reserved.
          </p>
